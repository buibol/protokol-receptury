...
- wyszukiwanie recept według dnia,
- pobieranie danych recepty i składników,
- automatyczne przenoszenie ilości przepisanych,
...
Aktualna wersja programu dostępna jest w sekcji **Releases** tego repozytorium.

Program przeznaczony jest dla systemów Windows 10/11 64-bit.

## Aktywacja

Program wymaga aktywacji.

W celu uzyskania aktywacji lub sprawdzenia kompatybilności instalacji prosimy o kontakt:

**Biuro Usług Informatycznych – Krzysztof Sulich**  
krzysiek@ksbiuro.pl
